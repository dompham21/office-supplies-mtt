...
export default function AdminPosterPage() {
    ...
    return (
        <>
            ...
            <PosterTable sortField={sortField} sortDirection={sortDirection} posters={data?.posters} onPagination={handlePagination} totalPage={data?.totalPage} pageSize={10}  pageNo={data?.pageNo} keyword={searchTerm}/>
        </>
    )
}

AdminPosterPage.authenticate = {
    permissions: ["ADMIN"],
  };

AdminPosterPage.Layout = AdminLayout;
