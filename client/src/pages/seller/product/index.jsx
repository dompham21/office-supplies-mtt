...
import { useProductsSellerQuery } from '@data/product/seller/use-products-seller.query';
...
SellerProductPage.authenticate = {
    permissions: ["SELLER"],
  };

  SellerProductPage.Layout = SellerLayout;
