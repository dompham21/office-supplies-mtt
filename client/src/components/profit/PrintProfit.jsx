...
function PrintProfit({revenue, fromDate, toDate}) {
  ...
  return (
    <Fragment>
      ...
      <div ref={componentRef} className='text-base px-2 ml-2'>
        ...
        <div className='py-2 flex justify-center items-center font-bold'>BÁO CÁO LỢI NHUẬN THEO THÁNG</div>
        ...
        <div className='m-2 flex justify-start gap-1'>Tổng tiền lợi nhuận:<span className='font-semibold'>{currencyMoney(calTotal())}</span></div>
