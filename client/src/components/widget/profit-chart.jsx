...
import ModalProfit from '@components/profit/ModalProfit';
    ...
    return (
        <div className="bg-light shadow-sm rounded w-full h-full p-8">
          <div className='flex items-center gap-4'>
            <div>
              <div className='my-4 font-semibold'>Chọn khoảng thời gian muốn báo cáo lợi nhuận theo tháng</div>
          ...
          {open &&
          <ModalProfit open={open} setOpen={setOpen} fromDate={fromDate} toDate={toDate}/>}
        </div>
    )
}
