...
import { usePurchaseOrderDetailQuery } from "@data/purchase/admin/use-purchase-order-detail.query";
import { currencyMoney } from "@utils/format-currency";

export default function ViewPurchaseDetail({ id, open, setIsModalOpen }) {
  const {
    data,
    isLoading: loading,
    error,
  } = usePurchaseOrderDetailQuery(id);
  ...
  const isValid = !loading && data?.purchaseOrder
  return (
          ...
          <div className='px-[30px] py-6 flex items-start'>
            <div style={{flex: 1}}>
              ...
              <div className='w-full flex items-center'>
                ...
                <div className='pl-5 flex-1 flex items-center  pb-[30px]  font-medium'>
                  <div>{data?.purchaseOrder?.supplier?.name}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center  pb-[30px]  font-medium'>
                    <div>{data?.purchaseOrder?.supplier?.email}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center pb-[30px]  font-medium'>
                    <div>{data?.purchaseOrder?.supplier?.phone}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center pb-[30px]  font-medium'>
                    <div>{data?.purchaseOrder?.supplier?.website}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center pb-[30px]  font-medium'>
                    <div>{data?.purchaseOrder?.supplier?.address}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center pb-[30px]  font-medium'>
                    <div>{formatDateDDMMYYYY(data?.purchaseOrder?.date)}</div>
                </div>
              </div>
              <div className='w-full flex items-center'>
                <div className='text-[#555555cc] w-[30%] flex justify-start items-center pb-[30px]'>
                ...
                <div className='pl-5 flex-1 flex items-center pb-[30px]  font-medium'>
                    <div>{data?.purchaseOrder?.staff?.name}</div>
                </div>
              </div>
            </div>
            <div className='flex justify-center h-full border-l w-96 pl-4 flex-col'>
              <div className='w-full flex items-center'>
                ...
                <div className='pl-5 flex-1 flex items-center  pb-[30px] font-medium'>
                  <div>{currencyMoney(calculatorTotal(data?.purchaseOrder?.purchaseOrderDetails))}</div>
                </div>
              </div>
              <div className="font-bold text-base mb-4">Danh sách sản phẩm</div>
              <div className="flex flex-col">
              {
                data?.purchaseOrder?.purchaseOrderDetails && data?.purchaseOrder?.purchaseOrderDetails?.map(od => (
