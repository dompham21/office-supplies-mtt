...
import { useRegisterSellerMutation } from '@data/user/seller/use-register-seller.mutation';
...
function RegistrationFormSeller() {
  ...
  const { mutate: registerUser, isLoading: loading } = useRegisterSellerMutation();
        ...
        onSuccess: (value) => {
          ...
          if (response) {
            ...
            if (result == 1) {
              ...
              router.push(ROUTES.SELLER_VERIFY);
            } else if (result == 0) {
              setErrorMessage(msg);
              return;
            }
