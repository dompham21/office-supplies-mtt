...
public class PosterServiceImpl implements PosterService {
    ...
    public Poster getPosterById(String id) throws PosterNotFoundException {
        try {
    ...
    public void deletePoster(String id) throws PosterNotFoundException {
        try {
            Poster poster = posterRepository.findById(id).get();
    ...
    public void approvePoster(String id) throws PosterNotFoundException {
        try {
            Poster poster = posterRepository.findById(id).get();
    ...
    public boolean existsByName(String name) {
        return posterRepository.existsByName(name);
    }
