...
import com.luv2code.doan.response.ListProductResponse;
import com.luv2code.doan.response.ProductResponse;
...
public class SellerProductRestController {
    ...
    public ResponseEntity<?> addProduct(Authentication authentication, @Valid @RequestBody ProductRequest body, HttpServletRequest request) throws BrandNotFoundException, CategoryNotFoundException, IOException, UserNotFoundException, NotFoundException, DuplicateException, ProductNotFoundException, SupplierNotFoundException {
        ...
        Product productAfterSave = productService.addProductSeller(body, seller);
...
//    }
    ...
    @ResponseBody
    public ResponseEntity<ListProductResponse> findProductsSeller(Authentication authentication,
        ...
        Page page = productService.getListProductsSeller(pageNo, pageSize, sortField, sortDirection, keyword, seller);
