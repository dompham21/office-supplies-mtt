...
public class ChangePasswordRequest {
    ...
    @Size(max = 50, message = "Old password should be less than 50 characters")
    ...
    @Size(max = 50, message = "New password should be less than 50 characters")
    ...
    @Size(max = 50, message = "Confirm password should be less than 50 characters")
